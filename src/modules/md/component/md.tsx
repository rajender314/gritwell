...
import { ClientID, ClientName, ClientNamePic, RightContainer, UserListContainer, RightContent, SecondaryHeaderContainer } from '../../../styles/common-styles';
import { triggerApi } from '../.././../services';
import { } from '../../users/component/add-user-components';
...
export default function MDClients() {
	...
	useEffect(() => {
		...
		setShowSpinner(true)
		getClientsList(userPermissions)
	}, [userPermissions])
			...
			.then((res: ApiResponseProps) => {
				...
				res.data.result.map((data: ClientProps) => {
					clientObj = {
						...
						// col3: (data.md_assignment.first_name ? data.md_assignment.first_name : '') + ' ' + (data.md_assignment.last_name ? data.md_assignment.last_name : ''),
