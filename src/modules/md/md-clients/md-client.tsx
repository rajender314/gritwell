	...
	return (
		<>
					...
					<ClientSummaryBlock>
						<div className="clientSummary">
							...
							<div className="summaryDetails">
								<div className={"linkBtn " + (clientDetails.client_msq === true ? "" : "disabled")}>
									<div onClick={symptomAnalysisData}> <SymptomAnalysisIcon /><span>Symptom Analysis</span></div>
								</div>
								<div className={"linkBtn " + (clientDetails.client_intake === true ? "" : "disabled")}>
									<div onClick={intakeForn}> <IntakeFormIcon /><span>Intake Form</span></div>
								</div>
								<div className={"linkBtn " + (clientDetails.client_past_test === true ? "" : "disabled")}>
									<div onClick={docView}> <PdfIcon /><span>Historical Tests</span></div>
								</div>
							</div>
						</div> */}
						{/* {notes && notes.map((note: any, index: number) => {
							return <PiRteBox
								...
								lastUpdated={DateFormats(note.updatlast_modified_dateedAt)}
			...
			{/* <PiAssignmentBoxMDSideDrawer
				...
				// onOnSearchClearKeyUp={function noRefCheck() { }}
				onSubmitAssign={() => console.log()}
